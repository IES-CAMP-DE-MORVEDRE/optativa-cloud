...
Cada volumen se **replica automáticamente dentro de una zona de disponibilidad**, garantizando **alta disponibilidad y durabilidad**, además de un **rendimiento constante y baja latencia**. Permite **ajustar la capacidad rápidamente** (aumentar o reducir en minutos) y **pagar solo por el almacenamiento aprovisionado**.
