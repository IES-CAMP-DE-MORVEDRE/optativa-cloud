...
AWS se encarga de escalar, mantener y ejecutar el servicio bajo demanda.Por ejemplo, en el caso de AWS Lambda (ejecución de funciones sin servidor), el usuario sólo debe subir el código y paga **únicamente por ejecución**, no por servidores encendidos.
