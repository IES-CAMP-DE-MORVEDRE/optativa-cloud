...
Práctica 2. Lambda con url de activación
Práctica 3. Lambda con parámetros
Práctica 4. Lambda con disparador tiempo
Práctica 5. Lambda con disparador S3
Práctica 6. Lambda con DynamoDB y API Gateway

Creación de una función Lambda básica.

<img src="../images/ud06/practica1/lambda01.png" width="600">
